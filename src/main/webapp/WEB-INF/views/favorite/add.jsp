		...
		<form action="./add" method="post">
			<ul class="list-group text-center">
				...
				<li class="list-group-item"> 
					<input type="hidden" name="cn_num" value="${favorNums.cn_num}">
			...
			<ul class="list-group text-center">
				...
				<li class="list-group-item">
					<input type="hidden" name="rt_num" value="${favorNums.rt_num}">
			...
			<ul class="list-group text-center">
				...
				<li class="list-group-item">
					<input type="hidden" name="fv_num" value="${favorNums.fv_num}">
