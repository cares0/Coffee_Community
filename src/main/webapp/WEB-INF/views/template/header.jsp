...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>    
	...
	<div class="container-fluid">
		<div class="main_header row align-items-center justify-content-between">
			<div class="col">
				<a class="header_nav" href="/p1/board/list?sort=1">공지사항</a>
		 		<a class="header_nav" href="/p1/board/list?sort=2">자유게시판</a>
				<a class="header_nav" href="/p1/board/list?sort=3">질문게시판</a>
				<a class="header_nav" href="/p1/board/list?sort=4">센서리게시판</a>
			</div>
